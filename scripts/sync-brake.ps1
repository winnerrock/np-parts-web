# sync-brake.ps1 — ดึงอะไหล่ระบบเบรคจาก KACC9 → sync-output.json
# ใช้: pwsh sync-brake.ps1
...
Write-Host "กำลังดึงข้อมูลระบบเบรคจาก KACC9..." -ForegroundColor Cyan
