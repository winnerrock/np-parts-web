# sync-belt.ps1 — ดึงสายพานจาก KACC9 → sync-output.json
# ใช้: pwsh sync-belt.ps1
...
Write-Host "กำลังดึงข้อมูลสายพานจาก KACC9..." -ForegroundColor Cyan
